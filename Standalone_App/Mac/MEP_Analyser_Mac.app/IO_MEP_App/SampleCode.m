...
[full_distribution, Y_corresp] = myModel.calculateLikelihoodDistribution(modelParameters, 6, true);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Static Function: calculateQuantile
% calculate the 95% CI of the model
Yquantile = myModel.calculateQuantile(modelParameters, 100, 1);
y_ci = myModel.modelCurveFunction(modelParameters, x);
...
figureClass.plotMEPIOCurveVariability(a1, modelParameters, myModel.modelName, true)

% Plot excitability and its corresponding p-value
figureClass.plotExcitabilityLevel(a2, a3, modelParameters, myModel.modelName)
