classdef modelCalibration < handle
    ...
    methods
        ...
        function str = repEmptyProp(~, property)
            if isempty(property)
                str = 'NaN';
            else
        ...
        function resultTable = summariseOptiTable(obj, finishedFlag)
            % This cell contains all model information
                cellTable = {'Model Information',                           ' ';
                             'Curve model:',                                obj.selectedCurveModelValue;
            ...
            switch obj.selectedCurveModelValue
                case 'Hill Function (5DoF)'
                    ...
                    if obj.vx_selected
                        ...
                        obj.iniPoints = obj.selectedCurveModelClass.opti_iniPoints(1:6);
                        bounds = obj.selectedCurveModelClass.opti_bounds(:, 1:6);
                    end
