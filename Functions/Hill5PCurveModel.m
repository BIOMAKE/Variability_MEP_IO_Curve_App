classdef Hill5PCurveModel < handle
    ...
    methods(Static)
        ...
        function [full_distribution, Youtput_corresp] = calculateLikelihoodDistribution(parameters, xivec, vx_selected)
            ...
            sigma_y = parameters(6); sigma_x = parameters(7);
            ...
            switch vx_selected
                ...
                case false
                    ...
                    full_distribution = normpdf(Youtput_corresp, 0, sigma_y);
            end
        end


        %% calculate quantiles for error band
        function Yquantile = calculateQuantile(parameters, xmax, vx_selected)
            % Input argument:
            ...
            xvec = linspace(0, xmax, 1000); % provide a x-range
