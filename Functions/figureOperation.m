classdef figureOperation < handle
    ...
    methods
        ...
        function plotSingleMEPIOCurve(obj, figHandle, parameters, selectedCurveModelValue)
            ...
            x_model = linspace(0, max(obj.x_axis), 1000); % define model x range
        ...
        function plotMEPIOCurveVariability(obj, figHandle, parameters, selectedCurveModelValue, vx_selected)
            ...
            Yquantile = figureOperation.calculateYquantile(parameters, selectedCurveModelValue, max(obj.x_axis), vx_selected);
    ...
    methods(Static)
        ...
        function Yquantile = calculateYquantile(parameters, selectedCurveModelValue, xmax, vx_selected)
            % switch condition
            switch selectedCurveModelValue
                case 'Hill Function (5DoF)'
                    Yquantile = Hill5PCurveModel.calculateQuantile(parameters, xmax, vx_selected);
                otherwise
                    % do nothing
            end
        end
